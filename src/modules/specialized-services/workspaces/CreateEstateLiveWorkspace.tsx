          ...
          <section className="commercial-form-section">
            <div className="commercial-form-section-heading">
              <div>
                ...
                <p>
                  Set reservation and installment rules that apply when creating purchases in this
                  estate.
                </p>
              </div>
            </div>
              ...
              <form.Field name="reservationAllowed">
                {(field) => (
                  <label className="commercial-check commercial-form-span">
                    ...
                    />
                    <span>Allow reservations before full payment</span>
                  </label>
                )}
              </form.Field>
                ...
                {(allowed) =>
                  allowed ? (
                    <>
                      <form.Field name="reservationThresholdPercent">
                        {(field) => (
                          <label className="commercial-field">
                            ...
                            />
                            <small>
                              Share of the agreed purchase price that must be verified before the
                              property moves to Reserved.
                            </small>
                      ...
                      <form.Field name="reservationPaymentWindowHours">
                        {(field) => (
                          <label className="commercial-field">
                            <span>
                              Initial payment window (hours) <em>*</em>
                            </span>
                            <input
                              className="commercial-number-input"
                              type="number"
                            ...
                            />
                            <small>
                              Hours after a purchase is started for the first verified payment to
                              clear. After that, the purchase can expire.
                            </small>
                          </label>
                        )}
                      </form.Field>
                    ...
                    <div className="commercial-notice commercial-form-span">
                      Reservations are turned off for this estate. Purchases can still use full
                      payment
                      {form.state.values.installmentAllowed ? ' or installments' : ''}.
                    </div>
                  )
                }
              </form.Subscribe>
              ...
              <form.Field name="installmentAllowed">
                {(field) => (
                  <label className="commercial-check commercial-form-span">
                    ...
                    />
                    <span>Allow installment payment plans</span>
                  </label>
                )}
              </form.Field>
                ...
                {(allowed) =>
                  allowed ? (
                    <form.Field name="maxInstallmentMonths">
                      {(field) => (
                        <label className="commercial-field">
                          <span>Maximum plan length (months)</span>
                          <input
                            className="commercial-number-input"
                            type="number"
                            min={1}
                          ...
                          />
                          <small>
                            Longest installment term staff can offer on purchases in this estate.
                            Leave blank for no estate maximum.
                          </small>
                        </label>
                      )}
                    </form.Field>
                    ...
                    <div className="commercial-notice commercial-form-span">
                      Installment plans are turned off for this estate.
                    </div>
                  )
                }
              </form.Subscribe>
